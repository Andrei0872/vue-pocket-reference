...
* Data: strings, numbers, boolean values, arrays, objects...

* Actions: functions provided by the child components that the parent can call to invoke some *behavior in the child component*

* Bindings: collections of attributes or event handlers that should be bound to a specific elements
